    ...
    <div className="m-20">
      <div className="mb-10 text-center">
        <p className="font-bold text-2xl ml-5">
          Welcome to E-Comm – Your Ultimate Shopping Destination!
        </p>
      </div>
      ...
      <div>
        ...
        <p className="ml-5 mt-2">
          ...
          of high-quality products and bringing them to your fingertips. Whether
          you're a fashion enthusiast, a tech guru, or someone looking for
          unique finds, we've got you covered.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="ml-5 mt-2">
          ...
          crafted using ReactJS for a smooth and responsive interface,
          TailwindCSS for a visually appealing layout, and Redux-toolkit to
          ensure efficient state management. We've leveraged the power of these
          technologies to create a platform that's not only visually stunning
        ...
        <ol className="ml-2">
          ...
          <li className="mt-2 mb-2">
            ...
            <p className="ml-5 mt-1">
              ...
              categories to cater to your unique needs and preferences. From the
              latest fashion trends to cutting-edge gadgets, we have it all.
            </p>
          </li>
