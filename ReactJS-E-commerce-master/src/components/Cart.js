      ...
      <div className="object-contain w-full font-bold m-5 p-5 rounded-md md:flex md:justify-around md:items-center border-2 border-gray-600">
        ...
        <div className="flex items-center mt-2 mb-2 md:flex md:flex-col">
          ...
          <div className="flex flex-row items-center text-center ml-8 md:flex-col">
            <button
              className="bg-[#9f2089] rounded-full text-white m-3 p-2 w-fit"
        ...
        <div className="flex sm:flex-col">
          <Link
            to={`/ReactJS-E-commerce/product/${id}`}
            className="p-2 bg-[#9f2089] text-white rounded-md  hover:bg-pink-500 mr-4 mt-4 mb-4"
          >
            Details
          </Link>
          <button
            onClick={() => handleRemove(id)}
            className="p-2 bg-[#9f2089] text-white rounded-md mt-4 mb-4"
          >
            Remove
          </button>
        </div>
